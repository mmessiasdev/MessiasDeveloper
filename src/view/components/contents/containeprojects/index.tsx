...
import ContentProjects from "../projects/containerprojsmall"
...
import ContentProjectsLarge from "../contentprojectsLarge";
...
const ContainerProjects = ({ scale, max }: props) => {
